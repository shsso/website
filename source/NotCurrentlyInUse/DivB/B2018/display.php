<?php
  ...
  $periodTime[1] = "9:00~9:50";
	...
	$eventName[0] =   "Battery Buggy";            
	$eventName[1] =   "Hovercraft";          
	$eventName[2] =   "Roller Coaster";
	$eventName[3] =   "Towers";
	$eventName[4] =   "Wright Stuff";
       
	
	$location[0] = "SMS Gym";
	$location[1] = "Parkside Gym";
	$location[2] = "Parkside Gym";
	$location[3] = "Lecture Hall";
	$location[4] = "SMS Gym";
...
<p align="center"><big><strong>2018 SOLON INVITATIONAL DIVISION B WALK-IN EVENT SCHEDULE</strong></p></big>
<p align="center"><big><strong>Saturday, Feb. 3, 2018</strong></p></big>
<br>
