...
<form ACTION="cdisplay.php" name="saveform" METHOD="POST" align="center">
    ...
    <tr>
      ...
      bgcolor="#FFFFFF" cellspacing="1" cellpadding="0">
        <tr>
          ...
          href="javascript:alert('The Team ID starts with C plus the team number.')"><small><small>Help</small></small></a></td>
        </tr>
        <tr align="center">
